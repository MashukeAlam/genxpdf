...
export default function TextToSpeechTranslator() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Mock API response
      const mockResponse = {
        audioContent: `Mock audio content for: ${inputText || 'Text from ' + file.name}. Language: ${language}, Accent: ${accent}.`,
      };
      ...
      const blob = new Blob([mockResponse.audioContent], { type: 'audio/mpeg' });
  ...
  return (
    ...
    >
      ...
      <div className="bg-white/70 backdrop-blur-md border border-blue-200/30 rounded-2xl p-8 max-w-lg w-full shadow-lg">
        <h1 className="text-2xl font-bold text-blue-900 mb-4 text-center">Text-to-Speech Translator</h1>
        <div
        ...
        />
        <div className="mb-4">
          <label className="block text-sm font-semibold text-blue-900 mb-2">Language:</label>
          <select
            value={language}
        ...
        <div className="mb-4">
          <label className="block text-sm font-semibold text-blue-900 mb-2">Accent:</label>
          <select
            value={accent}
        ...
        {audioUrl && (
          <div className="mt-4">
            <h3 className="text-lg font-semibold text-blue-900 mb-2">Translated Audio:</h3>
            <audio
              ref={audioRef}
              controls
              src={audioUrl}
