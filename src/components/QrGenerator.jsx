  ...
  return (
    ...
    >
      <div className="bg-white/70 backdrop-blur-md border border-blue-200/30 rounded-2xl p-8 max-w-lg w-full shadow-lg">
        ...
        <div className="mb-4">
          <label className="block text-sm font-semibold text-blue-900 mb-2">QR Code Text:</label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label className="block text-sm font-semibold text-blue-900 mb-2">QR Code Color:</label>
          <input
            type="color"
            value={color}
        ...
        <div className="mb-4">
          <label className="block text-sm font-semibold text-blue-900 mb-2">Logo (Optional):</label>
